...
//    INICIANDO VARIAVEIS
//---------------------------------------
String ipLocalString, buff, URL, linha, GLP,FUMACA, retorno, serv, logtxt = "sim", hora_ntp, hora_rtc,  LIMITE_MQ2, buf,s_senha_alarme = "123456", formattedDate, dayStamp, timeStamp;
const char *json, *ssid, *password, *servidor, *conslog, *nivelLog = "4", *verao;
